...
### Example: Hermes + ChatGPT/Codex + Claude Code setup

For a public-safe multi-model architecture, read [docs/HERMES-MULTI-MODEL-SETUP.md](docs/HERMES-MULTI-MODEL-SETUP.md). It explains Hermes as coordinator, ChatGPT/OpenAI Codex as the main model, Claude Code/Sonnet as a bounded worker, and Career-Ops as the job-search workflow layer.
