#!/usr/bin/env node
// One-shot: convert a markdown file to PDF via Playwright (no external md library)
// Usage: node convert-md-to-pdf.mjs <input.md> <output.pdf>
...
if (!inputMd || !outputPdf) {
  console.error('Usage: node convert-md-to-pdf.mjs <input.md> <output.pdf>');
  process.exit(1);
}
