...
| `dashboard-demo/` | Safe fictional dataset for the web dashboards: tracker, pipeline, reports, prep notes, placeholder PDFs, and a profile with calendar sync disabled |
...
5. Run `npm run dashboard:demo` if you want a no-setup web dashboard smoke test before adding your own data.
