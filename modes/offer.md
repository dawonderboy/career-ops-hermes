...
Classify the offer into one of the 6 archetypes (see `_shared.md`). If it is hybrid, indicate the 2 closest ones. This determines:
...
- **Niche/executive roles:** Staff+, VP, Director, or highly specialized roles legitimately take longer to fill. Adjust age thresholds accordingly.
