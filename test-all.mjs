...
if (!QUICK) {
  console.log('\n4. Dashboard build');
  const goAvailable = run('command -v go >/dev/null 2>&1 && go version');
  if (goAvailable === null) {
    warn('Dashboard Go build skipped: go is not installed');
  } else {
...
const allowedFiles = [
  ...
  'README.md', 'README.cn.md', 'README.es.md', 'README.ja.md', 'README.ko-KR.md',
  ...
  '.github/SECURITY.md', '.claude-plugin/marketplace.json', '.claude-plugin/plugin.json',
